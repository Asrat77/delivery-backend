...
exports.markPaid = exports.get = void 0;
...
exports.get = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("Payment", payment));
});
exports.markPaid = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const payment = await paymentsService.markPaid({
        shipmentId: String(req.params.shipmentId),
        actorRole: req.user.role,
        providerReference: req.body.providerReference,
    });
    return res.status(200).json((0, response_1.successResponse)("Payment marked as paid", payment));
});
