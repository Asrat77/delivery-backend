...
exports.updateRole = exports.updateStatus = exports.getUser = exports.listUsers = exports.createUser = void 0;
...
exports.listUsers = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("Users", data));
});
exports.getUser = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const user = await usersService.getUser(String(req.params.id));
    return res.status(200).json((0, response_1.successResponse)("User", user));
});
exports.updateStatus = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("User status updated", user));
});
exports.updateRole = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("User role updated", user));
});
