...
exports.getById = exports.list = void 0;
...
exports.list = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("Activity", data));
});
exports.getById = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return res.status(200).json((0, response_1.successResponse)("Activity detail", data));
});
