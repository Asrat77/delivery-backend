...
router.post("/verify-registration", (0, validate_middleware_1.validate)(auth_validation_1.verifyRegistrationSchema), authController.verifyRegistration);
router.post("/login", (0, validate_middleware_1.validate)(auth_validation_1.loginSchema), authController.login);
router.post("/verify-login", (0, validate_middleware_1.validate)(auth_validation_1.verifyLoginSchema), authController.verifyLogin);
